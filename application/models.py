...
class Users(db.Model,UserMixin):
    ...
    companyinitials = db.Column(db.String(100),nullable=True)
...
class UsersSchema(ma.Schema):
    class Meta:
        fields = ('id','email','password','phone_no','firstname','lastname','companyname','companyinitials','role','primary_contact','postal_code')
...
class Products(db.Model):
    ...
    quality_description = db.Column(db.String(1000))
...
class ProductSchema(ma.Schema):
    class Meta:
        fields = ('product_id','product_name','product_description','is_favorite','quality_description','posted_by','sku_code','hsn_code','product_picture1','product_picture2','product_picture3','moq','price','tags','stock_keeping_unit','variant','tax_tier','order_unit','posted_date','companyname','category','phone_no')
...
class NotificationsSchema(ma.Schema):
    class Meta:
        fields=("notification_id","notification_created_by","notification_for","text","is_seen",'firstname','lastname','companyname')
